...
# Set machine sleep to 120 minutes while charging
...
# Enable tabbed browsing in Finder
...
# Decrease the spring loading delay for directories (default 0.5)
...
# Disable Spotlight keyboard shortcut (⌘ + Space) (Will use Raycast instead)
